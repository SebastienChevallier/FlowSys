...
namespace GAME.FlowSys
{
    ...
    [CreateAssetMenu(fileName = "Step_New", menuName = "GAME/FlowSys/Mission Step", order = 2)]
    public class MissionStepConfigSO : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        private void EnsureManagedActionEntries()
        {
            for (int i = 0; i < actions.Count; i++)
            {
                ...
                global::GAME.FlowSys.MissionManagedDataFactory.RefreshActionEntry(entry);
            }
        }
        ...
        private void EnsureManagedConditionEntries()
        {
            for (int i = 0; i < conditions.Count; i++)
            {
                ...
                global::GAME.FlowSys.MissionManagedDataFactory.RefreshConditionEntry(entry);
            }
        }
