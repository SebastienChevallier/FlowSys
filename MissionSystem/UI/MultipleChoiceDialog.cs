...
namespace GAME.MissionSystem
{
    public class MultipleChoiceDialog : MonoBehaviour
    {
        ...
        public void Show(string questionLocKey, string[] choiceLocKeys, int correctIndex, string correctSnd, string wrongSnd, Action<int> callback)
        {
            ...
            Debug.Log($"[MissionSystem] MultipleChoiceDialog.Show: dialogActive={gameObject.activeInHierarchy}, phonePanel={phonePanelState}, choicesPanel={choicesPanelState}");
        }
        ...
        private void OnChoiceClicked(int choiceIndex)
        {
            ...
            string soundId = isCorrect ? correctSoundId : wrongSoundId;
