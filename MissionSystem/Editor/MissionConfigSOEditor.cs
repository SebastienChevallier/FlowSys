...
namespace GAME.MissionSystem.Editor
{
    ...
    public class MissionConfigSOEditor : UnityEditor.Editor
    {
        ...
        private void CreateNewStep()
        {
            ...
            Debug.Log($"[MissionSystem] Created new step: {stepPath}");
        }
        ...
        private void TestMission()
        {
            ...
            {
                Debug.LogWarning("[MissionSystem] MissionConfigSO is no longer the primary runtime mission asset. Launch the mission from MissionFlowConfigSO via MissionMappingConfigSO/GameFlowManager.");
            }
            else
            {
                Debug.LogWarning("[MissionSystem] Enter Play Mode to test the mission");
            }
        }
